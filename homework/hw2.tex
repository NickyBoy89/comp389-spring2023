...
\begin{enumerate}
  \item Let $F$ be a keyed function and consider the following experiment:
    ...
    Pseudorandom according to this experiment is when the adversary cannot determine whether the output comes from a pseudorandom function or a uniform function. And according to this problem, the output is defined to be 1 or 0 indicating that you cannot distinguish between the outputs. 
